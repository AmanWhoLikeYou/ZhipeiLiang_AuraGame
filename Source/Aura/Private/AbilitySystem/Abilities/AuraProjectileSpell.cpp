...
void UAuraProjectileSpell::SpawnProjectile(const FVector& ProjectileTagetLocation, const FGameplayTag& SocketTag, const bool bOverridePitch, const float OverridePitch)
{
